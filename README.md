...
**Check Complete step by step blog here: [dev.to](https://dev.to/aws-builders/end-to-end-generative-ai-mini-project-on-aws-using-aws-bedrock-aws-lambda-api-gateway-and-s3-4fp4)**
